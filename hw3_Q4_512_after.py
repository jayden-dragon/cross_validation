...
from tensorflow.keras.layers import GlobalAveragePooling2D, BatchNormalization, Activation, Dense
...
model = load_model('chest_x-ray_pretrained_before_4-512.h5')
...
# saving the model
model.save('chest_x-ray_pretrained_after_4-512.h5')
...
plot_loss(history)
plt.savefig('hw3_4-512_after.loss.png')
plt.clf()
plot_acc(history)
plt.savefig('hw3_4-512_after.accuracy.png')
