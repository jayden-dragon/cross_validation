...
model = load_model('chest_x-ray_4_extra_before.h5')
...
# saving the model
model.save('chest_x-ray_4_extra_after_4.h5')
...
plot_loss(history)
plt.savefig('hw3_4_extra_after.loss.png')
plt.clf()
plot_acc(history)
plt.savefig('hw3_4_extra_after.accuracy.png')
