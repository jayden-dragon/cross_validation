...
model = load_model('chest_x-ray_pretrained_before_3.h5')
...
# saving the model
model.save('chest_x-ray_pretrained_after_3.h5')
...
plot_loss(history)
plt.savefig('hw3_3_after.loss.png')
plt.clf()
plot_acc(history)
plt.savefig('hw3_3_after.accuracy.png')
