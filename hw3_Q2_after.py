...
model = load_model('chest_x-ray_pretrained_before.h5')
...
# saving the model
model.save('chest_x-ray_pretrained_after.h5')
...
plot_loss(history)
plt.savefig('hw3_2_after.loss.png')
plt.clf()
plot_acc(history)
plt.savefig('hw3_2_after.accuracy.png')
